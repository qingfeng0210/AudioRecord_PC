...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        Mqtt mqtt = new Mqtt();
        mqtt.mqttInit("test6475485454", "mymqtttest", this);
    ...
    private void findViewByIds(){
        btn_ntp = (Button)this.findViewById(R.id.btn_ntp);
    ...
    private void setListeners(){
        btn_ntp.setOnClickListener(btn_ntp_clickListener);
    ...
    private void init(){
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                try {
                    long ret = Ntp.query("pool.ntp.org");
                    Ntp.test();
                    Message msg = new Message();
                    Bundle data = new Bundle();
                    data.putString("value",String.valueOf(ret));
                    msg.setData(data);
    ...
    private Button.OnClickListener btn_ntp_clickListener = new Button.OnClickListener(){
